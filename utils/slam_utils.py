...
def get_loss_tracking(config, image, depth, opacity, viewpoint, initialization=False) -> torch.Tensor:
...
def get_loss_tracking_rgb(config, image, depth, opacity, viewpoint) -> torch.Tensor:
