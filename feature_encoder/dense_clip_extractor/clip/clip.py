...
from feature_encoder.dense_clip_extractor.clip.model import build_model
from feature_encoder.dense_clip_extractor.clip.simple_tokenizer import SimpleTokenizer as _Tokenizer
